...
echo "$Purple [3] Patching Web CSIRT Application $Color_Off"
...
then
    ...
    echo "$Yellow*****  WEB APPLICATION CSIRT v1.1 2024 INSTALLATION  *****$Color_Off"
    echo "$Yellow----------------------------------------------------------$Color_Off"
    Install_PHP8
    Install_AMP
    WebCSIRT_Configuration
...
then
    echo "$Yellow--------------------------------------------$Color_Off"
    echo "$Yellow*****  PATCHING WEB CSIRT APPLICATION  *****$Color_Off"
    echo "$Yellow--------------------------------------------$Color_Off"
    PatchWebCSIRTv01
elif [ $choice -eq 4 ]
then
    echo "$Yellow--------------------------------------------------$Color_Off"
    echo "$Yellow*****  WAZUH SECURITY PLATFORM INSTALLATION  *****$Color_Off"
    echo "$Yellow--------------------------------------------------$Color_Off"
    Wazuh_Installation
else
    exit 0;
